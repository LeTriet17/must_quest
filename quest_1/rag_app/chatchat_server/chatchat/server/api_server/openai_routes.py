...
DEFAULT_API_CONCURRENCIES = 5 # The default maximum concurrency for a single model
...
async def get_model_client(model_name: str) -> AsyncGenerator[AsyncClient]:
    '''
    To schedule models with the same name, Select idle models -> Models with the least current access count. 
    '''
    max_semaphore = 0
    selected_platform = ""
...
async def list_models() -> List:
    '''
    List all models from all platforms
    '''
